# the REANNZ HPC HPC Auth.Factors Setup & Jupyter Login
...
??? jupyter "3. Jupyter Login Details"
    ...
    2. <p>Enter the REANNZ HPC username, HPC password and 6 digit second factor token<br>![image](../theme_figures/jupyter_login_labels_updated.png)</p>
