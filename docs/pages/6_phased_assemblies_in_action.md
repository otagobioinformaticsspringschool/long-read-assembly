...
!!! terminal "code"
    ...
    ```bash
    ln -s /nesi/project/nesi02659/lra/resources/genome_assembly/chm13v2.0.fa chm13.fa
    ln -s /nesi/project/nesi02659/lra/resources/genome_assembly/assembly.haplotype2.fasta hg002.hap2.fa
    ln -s /nesi/project/nesi02659/lra/resources/genome_assembly/assembly.haplotype2.fasta.fai hg002.hap2.fa.fai
    ```
